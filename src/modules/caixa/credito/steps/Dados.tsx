 ...
 *
 * Exibe a "consulta" mockada da Caixa: nome, endereço, contas, saldo, renda.
 * O CPF é o real digitado pelo usuário; demais campos são fictícios.
 *
 * Botões:
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {rows.map((row, i) => (
            ...
            >
              ...
              <span style={{
                fontSize: 20, fontWeight: 600, color: '#374151', lineHeight: '150%',
              }}>
                {row.value}
              </span>
            </div>
